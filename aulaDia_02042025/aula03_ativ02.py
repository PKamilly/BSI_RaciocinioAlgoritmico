...
if caminho=="E" or caminho=="e":
    ...
    print("'Aquela luz pode ser um acampamento' - você pensa consigo")
    print("Você observa o reflexo da lua na leve correntesa pensa: 'Parece fundo...'")
    print("Seu estômago ronca.")
    print("Eu deveria seguir em frente?")
    print("Digite S para SIM | N para NAO")
